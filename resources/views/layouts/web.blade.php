            ...
            <div class="site-width">
                ...
                <ul id="side-menu" class="sidebar-menu">
                    <li class="dropdown"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>                  
                        <ul>
                            <li><a href="/home"><i class="icon-chart"></i> Sales Stats</a></li>
                            
                        </ul>
                    </li>
                    <li class="dropdown"><a href="#"><i class="icon-user mr-1"></i> Stakeholders</a>                  
                        <ul>
                            <li class="dropdown"><a href="#"><i class="icon-user"></i>Manage Suppliers</a>                               
                                <ul class="sub-menu">
                                    <li><a href="/suppliers"><i class="icon-lock"></i> Supplier Master</a></li>
                                    <li><a href="/sup-banking"><i class="icon-login"></i> Supplier Banking</a></li>
                                    <li><a href="/sup-terms"><i class="icon-direction"></i> Supplier Terms</a></li>
                                </ul>                               
                            </li>
                        </ul>                   
                    </li>
