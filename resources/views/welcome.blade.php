                    ...
                    <form method="POST" action="{{ route('login') }}" class="row row-eq-height lockscreen  mt-5 mb-5">
                        ...
                        <div class="login-form col-12 col-sm-7">
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror" type="email" id="emailaddress" value="developer@premedataservices.com" required="" placeholder="Enter your email">
                                @error('email')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('password') is-invalid @enderror" type="password" name="password" value="123456789" required="" id="password" placeholder="Enter your password">
                                @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="mt-2">Forgot Password? <a href="#">Recovery</a></div>
                        </div>
                    </form>
                </div>
